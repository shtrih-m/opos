...
begin
  ...
  Check(FiscalPrinter.beginFiscalReceipt(true));
  Check(FiscalPrinter.printRecMessage('                      КАССОВЫЙ ЧЕК                       '));
  Check(FiscalPrinter.printRecItem('3162506 МОС.ПР.Майон.КЛАСС.67% 750мл', 9180, 1000, 1, 10200, 'ST'));
  Check(FiscalPrinter.printRecItemAdjustment(1, '', 1020, 1));
  Check(FiscalPrinter.printRecItem('*8041 Нектар ДОБРЫЙ МУЛЬТИФРУТ     2л', 8500, 1000, 2, 8500, 'ST'));
  Check(FiscalPrinter.printRecItem('*3334592 ДОБРЫЙ Нектар пер.-ябл.2л', 8500, 1000, 2, 8500, 'ST'));
  Check(FiscalPrinter.printRecItem('*3443716 GREENR.Огурчики АППЕТ.мар720мл', 7500, 1000, 1, 7500, 'ST'));
  Check(FiscalPrinter.printRecItem('*3314610 GL.VIL.Томаты ЧЕРРИ мар.720мл', 5900, 1000, 1, 5900, 'ST'));
  Check(FiscalPrinter.printRecItem('*3345854 МК КЛИНС.Колб.МИНИ-САЛ.с/к 300г', 24600, 1000, 2, 24600, 'ST'));
  Check(FiscalPrinter.printRecItem('78004333 ОСТ.Свинина д/запекания охл.1кг', 38463, 1299, 2, 32900, 'г.'));
  Check(FiscalPrinter.printRecItemAdjustment(1, '', 4274, 1));
  Check(FiscalPrinter.printRecItem('3074007 Морковь мытая 1кг', 2333, 530, 2, 4890, 'г.' ));
  Check(FiscalPrinter.printRecItemAdjustment(1, '', 259, 1));
  Check(FiscalPrinter.printRecItem('*3219701 Огурцы короткоплодные 1кг', 2576, 430, 2, 5990, 'г.'));
  Check(FiscalPrinter.printRecItem('202 Томаты 1кг', 6654, 740, 2, 9990, 'г.'));
  Check(FiscalPrinter.printRecItemAdjustment(1, '', 739, 1));
  Check(FiscalPrinter.printRecItem('*3044397 Чеснок фасованный 1уп', 2890, 1000, 2, 2890, 'ST'));
  Check(FiscalPrinter.printRecItem('*3256556 Томаты ЧЕРРИ красные 250г', 5990, 1000, 2, 5990, 'ST'));
  Check(FiscalPrinter.printRecItem('3628395 САРАФ.Кефир дет.1,5% 930г', 5499, 1000, 2, 6110, 'ST'));
  Check(FiscalPrinter.printRecItemAdjustment(1, '', 611, 1));
  Check(FiscalPrinter.printRecItem('197 Лук репчатый 1кг', 1739, 440, 2, 4390, 'г.'));
  Check(FiscalPrinter.printRecItemAdjustment(1, '', 193, 1));
  Check(FiscalPrinter.printRecItem('*16791 BOND.Горошек зеленый ж/б 400г', 6200, 1000, 1, 6200, 'ST'));
  Check(FiscalPrinter.printRecItem('*3792 BOND.Кукур.слад.зерн.ж/б 340г', 6200, 1000, 1, 6200, 'ST'));
  Check(FiscalPrinter.printRecItem('*16791 BOND.Горошек зеленый ж/б 400г', 6200, 1000, 1, 6200, 'ST'));
  Check(FiscalPrinter.printRecItem('*3417568 ВЕЛК.Колб.САЛЯМ.КОР.п/к ср.370г', 19900, 1000, 2, 19900, 'ST'));
  Check(FiscalPrinter.printRecItem('*3417568 ВЕЛК.Колб.САЛЯМ.КОР.п/к ср.370г', 19900, 1000, 2, 19900, 'ST'));
  Check(FiscalPrinter.printRecItem('*3454250 Ч.ЛИН.Мор.пл.кр-бр.рож.12%110г', 6600, 1000, 2, 9900, 'ST'));
  Check(FiscalPrinter.printRecItemAdjustment(1, '', 3300, 2));
  Check(FiscalPrinter.printRecItem('*3454250 Ч.ЛИН.Мор.пл.кр-бр.рож.12%110г', 6600, 1000, 2, 9900, 'ST'));
  Check(FiscalPrinter.printRecItemAdjustment(1, '', 3300, 2));
  Check(FiscalPrinter.printRecItem('*3454250 Ч.ЛИН.Мор.пл.кр-бр.рож.12%110г', 6600, 1000, 2, 9900, 'ST'));
  Check(FiscalPrinter.printRecItemAdjustment(1, '', 3300, 2));
  Check(FiscalPrinter.printRecItem('*3380555 ШАРЛИЗ Суфле СЛИВКИ-ВАНИЛЬ 200г', 4500, 1000, 1, 4500, 'ST'));
  Check(FiscalPrinter.printRecItem('*3380555 ШАРЛИЗ Суфле СЛИВКИ-ВАНИЛЬ 200г', 4500, 1000, 1, 4500, 'ST'));
  Check(FiscalPrinter.printRecItem('*3363793 Ч-ЯГОДА Марм.Ябл/Апельс/Дыня250', 3900, 1000, 1, 3900, 'ST'));
  Check(FiscalPrinter.printRecItem('*3414014 Р.ФР.Марм.ЧУД.ЯГ.м./бр./ч.с.250', 3900, 1000, 1, 3900, 'ST'));
  Check(FiscalPrinter.printRecItem('*3275468 F.H.Икр.мойв.ар/копч.с/с 180г', 6990, 1000, 2, 6990, 'ST'));
  Check(FiscalPrinter.printRecItem('*3419749 NESC.Кофе GOL.BARISTA ст/б 85г', 19900, 1000, 1, 19900, 'ST'));
  Check(FiscalPrinter.printRecItem('3613025 САРАФ.Мол.отб.паст.д3,4-4%930мл', 5517, 1000, 2, 6130, 'ST'));
  Check(FiscalPrinter.printRecItemAdjustment(1, '', 613, 2));
  Check(FiscalPrinter.printRecItem('3172880 Батон НАРЕЗНОЙ нарезка п/э 380г', 2065, 1000, 2, 2295, 'ST'));
  Check(FiscalPrinter.printRecItemAdjustment(1, '', 230, 2));
  Check(FiscalPrinter.printRecItem('*3502314 Пиво ZATECKY GUS св.4,6% 0.45л', 5550, 1000, 1, 5550, 'ST'));
  Check(FiscalPrinter.printRecItem('*26877 BAHL.Печ.LEIBNIZ мин.сл.шок100г', 5900, 1000, 1, 5900, 'ST'));
  Check(FiscalPrinter.printRecItem('*3492143 BANINI Печенье чайн.с какао125г', 3500, 1000, 1, 3500, 'ST'));
  Check(FiscalPrinter.printRecItem('*3603447 BANINI Печенье чайн.ван.нач125г', 3500, 1000, 1, 3500, 'ST'));
  Check(FiscalPrinter.printRecItem('3400865 МЕРИД.Палоч.КРАБ.д/салата 200г', 8005, 1000, 2, 8895, 'ST'));
  Check(FiscalPrinter.printRecItemAdjustment(1, '', 890, 2));
  Check(FiscalPrinter.printRecItem('3400865 МЕРИД.Палоч.КРАБ.д/салата 200г', 8005, 1000, 2, 8895, 'ST'));
  Check(FiscalPrinter.printRecItemAdjustment(1, '', 890, 2));
  Check(FiscalPrinter.printRecItem('3182853 Яйца кур.С0 стол.фас.10шт', 4941, 1000, 2, 5490, 'ST'));
  Check(FiscalPrinter.printRecItemAdjustment(1, '', 549, 2));
  Check(FiscalPrinter.printRecItem('3341462 ЛЕТО Яйцо куриное С1 20шт', 13230, 1000, 2, 14700, 'ST'));
  Check(FiscalPrinter.printRecItemAdjustment(1, '', 1470, 2));
  Check(FiscalPrinter.printRecItem('49505 Дск Свекла варен.очищ.в/у 500г', 8622, 2000, 1, 4790, 'ST'));
  Check(FiscalPrinter.printRecItemAdjustment(1, '', 958, 1));
  Check(FiscalPrinter.printRecItem('*3454582 Вино АЛАЗ.ДОЛ.кр.п/сл.ст.0.75л', 21000, 1000, 1, 42000, 'ST'));
  Check(FiscalPrinter.printRecItemAdjustment(1, '', 21000, 1));
  Check(FiscalPrinter.printRecItem('*3454582 Вино АЛАЗ.ДОЛ.кр.п/сл.ст.0.75л', 21000, 1000, 1, 42000, 'ST'));
  Check(FiscalPrinter.printRecItemAdjustment(1, '', 21000, 1));
  Check(FiscalPrinter.printRecItem('71029 Зелень Укроп в упаковке 100г', 3591, 1000, 2, 3990, 'ST'));
  Check(FiscalPrinter.printRecItemAdjustment(1, '', 399, 2));
  Check(FiscalPrinter.printRecItem('*3256556 Томаты ЧЕРРИ красные 250г', 5990, 1000, 2, 5990, 'ST'));
  Check(FiscalPrinter.printRecItem('3335501 КРАСНАЯ ЦЕНА Сыр ГАУДА фас.1кг', 15809, 352, 2, 49900, 'г.'));
  Check(FiscalPrinter.printRecItemAdjustment(1, '', 1756, 2));
  Check(FiscalPrinter.printRecItem('*3385812 ВЕЛКОМ Колб.ДОКТОР.кус.в/уп500г', 17500, 1000, 2, 35000, 'ST'));
  Check(FiscalPrinter.printRecItemAdjustment(1, '', 17500, 2));
  Check(FiscalPrinter.printRecItem('*3385812 ВЕЛКОМ Колб.ДОКТОР.кус.в/уп500г', 17500, 1000, 2, 35000, 'ST'));
  Check(FiscalPrinter.printRecItemAdjustment(1, '', 17500, 2));
  Check(FiscalPrinter.printRecSubtotal(525190));
  Check(FiscalPrinter.printRecSubtotalAdjustment(1, '', 39));
  Check(FiscalPrinter.printRecSubtotal(423400));
  Check(FiscalPrinter.printRecTotal(423400, 423400, '10'));
  Check(FiscalPrinter.printRecTotal(423400, 423400, '0'));
  Check(FiscalPrinter.endFiscalReceipt(false));
end;
