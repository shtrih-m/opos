...
// Control Name     : TNCRCashDrawerService
...
// *********************************************************************//
  TNCRCashDrawerServiceDirectIOEvent = procedure(ASender: TObject; EventNumber: Integer; var pData: Integer;
                                                         var pString: WideString) of object;
  TNCRCashDrawerServiceStatusUpdateEvent = procedure(ASender: TObject; Data: Integer) of object;

  TNCRCashDrawerService = class(TOleControl)
  private
    FOnDirectIOEvent: TNCRCashDrawerServiceDirectIOEvent;
    FOnStatusUpdateEvent: TNCRCashDrawerServiceStatusUpdateEvent;
    FIntf: _DCashDrawer;
  ...
  published
    ...
    property OnDirectIOEvent: TNCRCashDrawerServiceDirectIOEvent read FOnDirectIOEvent write FOnDirectIOEvent;
    property OnStatusUpdateEvent: TNCRCashDrawerServiceStatusUpdateEvent read FOnStatusUpdateEvent write FOnStatusUpdateEvent;
  end;
...
procedure TNCRCashDrawerService.InitControlData;
const
...
procedure TNCRCashDrawerService.CreateControl;
...
function TNCRCashDrawerService.GetControlInterface: _DCashDrawer;
begin
  CreateControl;
  Result := FIntf;
end;

function TNCRCashDrawerService.Open(const DeviceName: WideString): Integer;
begin
  Result := DefaultInterface.Open(DeviceName);
end;

function TNCRCashDrawerService.Close: Integer;
begin
  Result := DefaultInterface.Close;
end;

function TNCRCashDrawerService.Claim(Timeout: Integer): Integer;
begin
  Result := DefaultInterface.Claim(Timeout);
end;

function TNCRCashDrawerService.Release: Integer;
begin
  Result := DefaultInterface.Release;
end;

function TNCRCashDrawerService.CheckHealth(Level: Integer): Integer;
begin
  Result := DefaultInterface.CheckHealth(Level);
end;

function TNCRCashDrawerService.DirectIO(Command: Integer; var pData: Integer; var pString: WideString): Integer;
begin
  Result := DefaultInterface.DirectIO(Command, pData, pString);
end;

function TNCRCashDrawerService.OpenDrawer: Integer;
begin
  Result := DefaultInterface.OpenDrawer;
end;

function TNCRCashDrawerService.WaitForDrawerClose(BeepTimeout: Integer; BeepFrequency: Integer;
                                        BeepDuration: Integer; BeepDelay: Integer): Integer;
begin
  Result := DefaultInterface.WaitForDrawerClose(BeepTimeout, BeepFrequency, BeepDuration, BeepDelay);
end;

function TNCRCashDrawerService.SOProcessID: Integer;
begin
...
procedure Register;
begin
  RegisterComponents(dtlOcxPage, [TNCRCashDrawerService]);
end;

function TNCRCashDrawerService.GetOpenResult: Integer;
begin
  Result := 0;
end;
