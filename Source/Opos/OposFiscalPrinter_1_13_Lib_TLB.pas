unit OposFiscalPrinter_1_13_Lib_TLB;
...
// PASTLWTR : 1.2
// File generated on 18.10.2011 12:00:03 from Type Library described below.

// ************************************************************************  //
// Type Lib: I:\Projects\OposShtrih\Source\Opos\OPOSFiscalPrinter.tlb (1)
// LIBID: {CCB90070-B81E-11D2-AB74-0040054C3719}
// LCID: 0
// Helpfile: 
// HelpString: OPOS FiscalPrinter Control 1.13.001 [Public, by CRM/RCS-Dayton]
// DepndLst: 
...
// *********************************************************************//
  ...
  IOPOSFiscalPrinter_1_6Disp = dispinterface;
  IOPOSFiscalPrinter_1_8 = interface;
  IOPOSFiscalPrinter_1_8Disp = dispinterface;
  IOPOSFiscalPrinter_1_9 = interface;
  IOPOSFiscalPrinter_1_9Disp = dispinterface;
  IOPOSFiscalPrinter_1_11 = interface;
  IOPOSFiscalPrinter_1_11Disp = dispinterface;
...
// *********************************************************************//
// DispIntf:  IOPOSFiscalPrinter_1_6Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {CCB92071-B81E-11D2-AB74-0040054C3719}
// *********************************************************************//
  IOPOSFiscalPrinter_1_6Disp = dispinterface
...
// *********************************************************************//
// DispIntf:  IOPOSFiscalPrinter_1_8Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {CCB93071-B81E-11D2-AB74-0040054C3719}
// *********************************************************************//
  IOPOSFiscalPrinter_1_8Disp = dispinterface
...
// *********************************************************************//
// DispIntf:  IOPOSFiscalPrinter_1_9Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {CCB94071-B81E-11D2-AB74-0040054C3719}
// *********************************************************************//
  IOPOSFiscalPrinter_1_9Disp = dispinterface
...
// *********************************************************************//
// DispIntf:  IOPOSFiscalPrinter_1_11Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {CCB95071-B81E-11D2-AB74-0040054C3719}
// *********************************************************************//
  IOPOSFiscalPrinter_1_11Disp = dispinterface
...
// *********************************************************************//
  IOPOSFiscalPrinter = interface(IOPOSFiscalPrinter_1_6)
...
// Help String      : OPOS FiscalPrinter Control 1.13.001 [Public, by CRM/RCS-Dayton]
...
// *********************************************************************//
  ...
  private
    ...
    function  GetDefaultInterface: OleVariant;
  ...
  public
    ...
    property  DefaultInterface: OleVariant read GetDefaultInterface;
...
function TOPOSFiscalPrinter.GetDefaultInterface: OleVariant;
begin
  CreateControl;
  Result := OleObject;
end;
