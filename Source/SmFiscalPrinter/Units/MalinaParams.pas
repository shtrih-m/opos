...
type
  ...
  public
    ...
    RosneftCardMask: WideString;
    RosneftCardName: WideString;
    RosneftAddTextEnabled: Boolean;
    RosneftItemName: WideString;
    RosneftItemDepartment: Integer;
    RosneftAddText: WideString;
    RetalixDBPath: WideString;
