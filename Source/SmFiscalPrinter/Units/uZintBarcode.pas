...
type
  ...
  public
    ...
    property Symbol: PZSymbol read FSymbol;
...
resourcestring
  MsgInternalSymbolStructure = 'Can not create internal symbol structure';
...
begin
  ...
  if not Assigned(FSymbol) then
    raise EZintError.Create(MsgInternalSymbolStructure);
end;
