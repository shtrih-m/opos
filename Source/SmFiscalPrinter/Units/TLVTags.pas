...
begin
  ...
  AddTag(1151, 'сумма коррекций НДС по ставке 20%', 'СУММА КОРРЕКЦИЙ НДС 20%', ttVLN, 8);
  AddTag(1152, 'сумма коррекций НДС по ставке 10%', 'СУММА КОРРЕКЦИЙ НДС 10%', ttVLN, 8);
  AddTag(1153, 'сумма коррекций НДС по расч. ставке 20/120', 'СУММА КОРРЕКЦИЙ НДС ПО РАСЧ. СТ. 20/120', ttVLN, 8);
  ...
  // Маркировка
  AddTag(2001, 'код справочника', 'КТН-КС', ttByteArray, 4);
  AddTag(2002, 'код код группы товаров', 'КТН-КГТ', ttByteArray, 4);
  AddTag(2003, 'код идентификации товара', 'КТН-КИТ', ttByteArray, 8);
